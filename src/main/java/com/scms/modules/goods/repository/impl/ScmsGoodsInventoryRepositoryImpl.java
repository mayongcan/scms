...
public class ScmsGoodsInventoryRepositoryImpl extends BaseRepository implements ScmsGoodsInventoryRepositoryCustom{
	...
	private static final String SQL_GET_LIST = "SELECT tb.ID as \"id\", tb.MERCHANTS_ID as \"merchantsId\", tb.SHOP_ID as \"shopId\", tb.GOODS_ID as \"goodsId\", tb.GOODS_BARCODE as \"goodsBarcode\", "
	        + "tb.COLOR_ID as \"colorId\", tb.COLOR_NAME as \"colorName\", tb.INVENTORY_SIZE_ID as \"inventorySizeId\", tb.INVENTORY_SIZE as \"inventorySize\", "
    ...
    private static final String SQL_GET_STATISTICS_GOODS_INVENTORY = "SELECT DISTINCT(tb.SHOP_ID) as shopId, "
            + "sum(tb.INVENTORY_NUM) as totalInventoryNum, si.SHOP_NAME as shopName, gi.PURCHASE_PRICE as purchasePrice "
