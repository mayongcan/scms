 ...
 */
@Repository
public interface ScmsMerchantsInfoRepository extends JpaRepository<ScmsMerchantsInfo, Long>, JpaSpecificationExecutor<ScmsMerchantsInfo>, ScmsMerchantsInfoRepositoryCustom {
	
    List<ScmsMerchantsInfo> findByUserIdAndIsValid(Long userId, String isValid);
	...
	@Query(value = "UPDATE scms_merchants_info "
