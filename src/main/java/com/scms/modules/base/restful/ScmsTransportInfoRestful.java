 ...
 */
package com.scms.modules.base.restful;
 ...
 */
@RestController
@RequestMapping("/api/scms/base")
public class ScmsTransportInfoRestful {

	protected static final Logger logger = LogManager.getLogger(ScmsTransportInfoRestful.class);
